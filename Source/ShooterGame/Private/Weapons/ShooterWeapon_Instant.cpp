...
//Function for getting DamageType
void AShooterWeapon_Instant::GetDamageType(TSubclassOf<UDamageType> &CurrDamageType) const
{
	CurrDamageType = InstantConfig.DamageType;
	return;
}

//Function for setting DamageType
void AShooterWeapon_Instant::SetDamageType(TSubclassOf<UDamageType> NewDamageType)
{
	InstantConfig.DamageType = NewDamageType;
}

//Function for setting DamageType on server
void AShooterWeapon_Instant::Server_SetDamageType_Implementation(TSubclassOf<UDamageType> NewDamageType)
{
	InstantConfig.DamageType = NewDamageType;
}
