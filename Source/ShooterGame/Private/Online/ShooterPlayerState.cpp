...
void AShooterPlayerState::SetJetpackFuel(float fuel) {
	JetpackFuel = fuel;
}

float AShooterPlayerState::GetJetpackFuel() {
	return JetpackFuel;
}


void AShooterPlayerState::SetRewindTime(float time) {
	RewindTime = time;
}

float AShooterPlayerState::GetRewindTime() {
	return RewindTime;
}

void AShooterPlayerState::SetMaxRewindTime(float time) {
	MaxRewindTime = time;
}

float AShooterPlayerState::GetMaxRewindTime() {
	return MaxRewindTime;
}

void AShooterPlayerState::SetShrinkTime(float time) {
	ShrinkTime = time;
}

void AShooterPlayerState::SetMaxShrinkTime(float time) {
	MaxShrinkTime = time;
}

float AShooterPlayerState::GetShrinkTime() {
	return ShrinkTime;
}

float AShooterPlayerState::GetMaxShrinkTime() {
