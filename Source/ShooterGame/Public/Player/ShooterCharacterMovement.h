...
private:
	...
	UFUNCTION(Server, Reliable) void ServerSetMoveDirection(FVector NewDir);
	...
	//wall jump
	void PhysWallJump(float deltaTime, int32 Iterations);
	UFUNCTION(Server, Reliable) void Server_SetWallJump();
