...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = Movement) class UShooterCharacterMovement* ShooterCharacterMovementComponent;
	
//Storing classes for pickups
protected:
	TSubclassOf<AShooterPickup> PickupGunClass;
	TSubclassOf<AShooterPickup> PickupLauncherClass;
