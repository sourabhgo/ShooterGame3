...
#include "ShooterWeapon.h" //For Weapon Dat
...
class AShooterPickup_Ammo : public AShooterPickup
{
	...
	//Should also allot weapon

	//setting up timer and respawn
	void SetupPickupWeapon();
	
	//ammo if pickup weapon
	int PickupWeaponAmmo;

	bool PickupWeapon;
		
	//Weapon Data
	FWeaponData PickupWeaponConfig;
...
protected:
	...
	//Timer to handle destroy
	FTimerHandle TimerHandle_Destroy;
	
	//Time to live for pickup
	float LiveTime;
};
